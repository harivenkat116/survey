...
@Controller
public class AddFullSurveyViaFormControllerJspTesting {

	@Autowired
	private SurveyeeInfoSurveysCreateService service;

		@RequestMapping(value = "/addfullsurveyformJspTesting", method = RequestMethod.GET)
		public ModelAndView createFullEmptySurvey() throws DAOException {
			ModelAndView modelAndView = new ModelAndView();
			modelAndView.setViewName("AddFullSurveyJspTesting");
			...
			System.out.println("http://localhost:9090/Survey2015/addfullsurveyformJspTesting - GET");
			return modelAndView;
		}
		
		@RequestMapping(value = "/addfullsurveyformJspTesting", method = RequestMethod.POST)
		public String saveFullSurveyRecord(FullSurveyRecord fullSurveyRecord) {
			...
			System.out.println("fullSurveyRecord.getSolvedOrNot() = " + fullSurveyRecord.getSolvedOrNot());
			System.out.println("fullSurveyRecord.getSolutionDegree() = " + fullSurveyRecord.getSolutionDegree());
			System.out.println("fullSurveyRecord.getWillToHelpRating() = " + fullSurveyRecord.getWillToHelpRating());
			System.out.println("fullSurveyRecord.getCourtesyRating() = " + fullSurveyRecord.getCourtesyRating());
/*			
			int surveyeeId = 0;
...
*/			System.out.println("http://localhost:9090/Survey2015/addfullsurveyformJspTesting - POST");
			return "Success";
		}
}
