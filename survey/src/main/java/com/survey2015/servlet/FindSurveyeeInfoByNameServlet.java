 ...
 */
public class FindSurveyeeInfoByNameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindSurveyeeInfoByNameServlet() {
        super();
...
*/
		...
		String surveyeeName = "%l%";
		
		try {
			List<SurveyeeInfo> surveyeeInfos = dao.findSurveyeeInfoByName(surveyeeName);
